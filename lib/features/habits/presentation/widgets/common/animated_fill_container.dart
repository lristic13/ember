                ...
                if (fillProgress > 0)
                  Align(
                    ...
                    child: FractionallySizedBox(
                      ...
                      child: DecoratedBox(
                        decoration: BoxDecoration(
                          // ~155° diagonal: lighter top-left → fill → darker
                          // bottom-right gives each cell a dimensional tile look.
                          gradient: LinearGradient(
                            begin: const Alignment(-0.9, -1),
                            end: const Alignment(0.9, 1),
                            colors: [
                              Color.lerp(widget.fillColor, Colors.white, 0.2)!,
                              widget.fillColor,
                              Color.lerp(widget.fillColor, Colors.black, 0.14)!,
                            ],
                            stops: const [0.0, 0.45, 1.0],
                          ),
                        ),
                        // Top sheen: a faint highlight along the top edge.
                        child: Align(
